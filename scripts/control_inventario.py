...
# ==========================================================
INVENTARIO_IN = "inventario_clasificado.json"
VENTAS_IN = "ventas_clasificado.json"
MEMORIA_FILE = "inventario_actualizado.json" 
KPIS_OUT = "kpis_inventario.json"
...
# MAIN
# ==========================================================
inventario_hoy = cargar_json(INVENTARIO_IN) or {"productos": []}
ventas_hoy = cargar_json(VENTAS_IN) or {"facturas_agrupadas": []}
...
for codigo, datos_memoria in memoria.items():
    ...
    # CORRECCIÓN 1: Si no está en inv_costos de hoy, usar el costo guardado en memoria
    ...
    # CORRECCIÓN 3: Solo ajustar diferencia si el producto vino en la toma física de hoy
